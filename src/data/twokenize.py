...
# from: https://github.com/myleott/ark-twokenize-py/blob/master/twokenize.py
# from the article below.
# as used in Demographic Dialectal Variation in Social Media: A Case Study of African-American English
